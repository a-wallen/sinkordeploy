...
var App = /** @class */ (function () {
  ...
  App.prototype.routes = function () {
    ...
    // });
    //get individual post details by id
    router.get("/app/memes/:memeId/", function (req, res) {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          this.Meme.retrieveMemeDetails(res, { memeId: req.params.memeId });
          return [2 /*return*/];
    ...
    router.get("/app/comments/:commentId", function (req, res) {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          this.Comment.retrieveComment(res, {
    ...
    router.get("/app/memes/comment/:memeId", function (req, res) {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
